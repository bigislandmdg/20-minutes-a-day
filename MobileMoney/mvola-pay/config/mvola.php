...
return [
    'sandbox' => [
        'base_url' => 'https://sandbox.mvola.mg',
        'token_url' => 'https://sandbox.mvola.mg/token',
        'transaction_url' => 'https://sandbox.mvola.mg/mvola/mm/transactions/type/merchantpay/1.0.0/',
